            ...
            <div className="w-full max-w-2xl mx-auto">
                ...
                <Card className="border-emerald-100 shadow-lg shadow-emerald-100/20 overflow-hidden">
                    <CardHeader className="bg-gradient-header text-white">
                        ...
                        <CardDescription className="text-emerald-50">{getStepDescription()}</CardDescription>
                    </CardHeader>
                        ...
                        <AnimatePresence mode="wait">
                            {step === "nin" && (
                                ...
                                >
                                    ...
                                    <Button type="submit" className="w-full text-white btn-primary" disabled={isLoading}>
                                        {isLoading ? (
                                            <>
                            ...
                            {step === "biometric" && (
                                ...
                                >
                                        ...
                                        <div className="relative w-48 h-48 mx-auto">
                                            <motion.div
                                                className={`absolute inset-0 rounded-full border-4 ${
                                                    isScanning ? "border-emerald-500" : "border-gray-300"
                                                ...
                                                <div className="absolute inset-0 flex items-center justify-center">
                                                    <motion.div
                                                        className={`w-32 h-32 rounded-full ${
                                                            isScanning ? "bg-emerald-100" : "bg-gray-100"
                                                    ...
                                                    >
                                                        <Fingerprint
                                                            className={`w-16 h-16 ${
                                                                isScanning ? "text-emerald-500" : "text-gray-400"
                                                            } transition-colors duration-300`}
                                                        />
                                                    </motion.div>
                                                </div>
                                    ...
                                    <Button
                                        ...
                                        disabled={isScanning}
                                        className={`w-full text-white btn-primary ${isScanning ? "opacity-50 cursor-not-allowed" : ""}`}
                                    >
                                        {isScanning ? (
                                            <>
                                                <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                    ...
                    <CardFooter className="bg-gray-50 px-6 py-4 flex justify-between">
                        ...
                        {step === "nin" && (
                            <div className="text-sm text-gray-500 w-full text-center">Secure verification platform for identity management</div>
                        )}
                        {step === "success" && (
                            <Button
                                variant="outline"
